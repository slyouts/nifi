...
public class StatelessPassThroughComponent extends AbstractTransactionalComponent implements TransactionalComponent {
    ...
    public boolean runRecursive(final Queue<InMemoryFlowFile> queue) {
        for (final TransactionalComponent component : getChildren().get(RELATIONSHIP)) {
