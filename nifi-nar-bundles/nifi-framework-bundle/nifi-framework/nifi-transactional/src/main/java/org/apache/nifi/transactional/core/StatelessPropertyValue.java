...
public class StatelessPropertyValue implements PropertyValue {
    ...
    private final TransactionalControllerServiceLookup serviceLookup;
    ...
    private StatelessPropertyValue(final String rawValue, final ControllerServiceLookup serviceLookup, final PropertyDescriptor propertyDescriptor, final boolean alreadyEvaluated,
        ...
        this.serviceLookup = (TransactionalControllerServiceLookup) serviceLookup;
    ...
    private void validateExpressionScope(boolean attributesAvailable) {
        ...
        if (expressionLanguageScope != null
            ...
            && this.serviceLookup instanceof TransactionalControllerServiceLookup) {
            return;
        }
