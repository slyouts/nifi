...
public class StatelessRemoteInputPort extends AbstractTransactionalComponent {
    private final Queue<TransactionalFlowFile> inputQueue = new LinkedList<>();
    ...
    public boolean runRecursive(final Queue<InMemoryFlowFile> queue) {
        try {
            ...
            TransactionalFlowFile flowFile;
