...
public class TransactionalEventAccess implements UserAwareEventAccess {
    ...
    public TransactionalEventAccess(final TransactionalFlowManager flowManager, final FlowFileEventRepository flowFileEventRepository,
            final ProvenanceRepository provenanceRepository, final ProcessScheduler processScheduler) {
        this.flowManager = flowManager;
        this.flowFileEventRepository = flowFileEventRepository;
        this.provenanceRepository = provenanceRepository;
        this.processScheduler = processScheduler;
        flowManager.setEventAccess(this);
    }
     ...
     *            the number of levels deep we should recurse and still include the the processors' statuses, the groups' statuses, etc. in the returned ProcessGroupStatus
     * @param currentDepth
     *            the current number of levels deep that we have recursed
     * @return the component status
     */
