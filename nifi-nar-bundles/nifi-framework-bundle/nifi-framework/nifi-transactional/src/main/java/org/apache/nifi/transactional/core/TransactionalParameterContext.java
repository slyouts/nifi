...
public class TransactionalParameterContext implements ParameterContext {
    private final Map<String, Parameter> parameterMap = new LinkedHashMap<>();
    private final String id;
    private final String name;

    public TransactionalParameterContext(final String id, final String name, final Map<String, Parameter> parameters) {
        this.id = id;
        this.name = name;
