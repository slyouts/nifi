...
import org.apache.nifi.transactional.core.TransactionalControllerServiceLookup;
import org.apache.nifi.transactional.core.TransactionalFlow;
import org.apache.nifi.transactional.core.TransactionalProcessorWrapper;
...
public class BatchTest {
    ...
    public void testScenario1_Test() throws Exception {
        ...
        TransactionalControllerServiceLookup serviceLookup = new TransactionalControllerServiceLookup(null);
        ...
        // Build Flow
        ///////////////////////////////////////////
        TransactionalProcessorWrapper getFile = new TransactionalProcessorWrapper(UUID.randomUUID().toString(), new GetFile(), null, serviceLookup, registry, ClassLoader.getSystemClassLoader(), null);
        ...
        TransactionalProcessorWrapper splitText = wrapProcessor(new SplitText(), serviceLookup, registry);
        ...
        TransactionalProcessorWrapper replaceText = wrapProcessor(new ReplaceText(), serviceLookup, registry);
        ...
        TransactionalProcessorWrapper putFile = wrapProcessor(new PutFile(), serviceLookup, registry);
        ...
        // Run Flow
        ///////////////////////////////////////////
        TransactionalFlow flow = new TransactionalFlow(getFile);

        Queue<TransactionalFlowFile> output = new LinkedList<>();
    ...
    private TransactionalProcessorWrapper wrapProcessor(final Processor processor, TransactionalControllerServiceLookup serviceLookup, final VariableRegistry registry)
            throws InvocationTargetException, IllegalAccessException {
        return new TransactionalProcessorWrapper(UUID.randomUUID().toString(), processor, null, serviceLookup, registry, ClassLoader.getSystemClassLoader(), null);
    }
}
