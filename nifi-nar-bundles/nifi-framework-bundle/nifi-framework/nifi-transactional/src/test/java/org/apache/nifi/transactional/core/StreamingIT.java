...
public class StreamingIT {
    ...
    public void Scenario1_Test() throws InvocationTargetException, IllegalAccessException, IOException, InterruptedException {
        ...
        // Build Flow
        ///////////////////////////////////////////
        TransactionalProcessorWrapper tailFile = wrapProcessor(new TailFile(), serviceLookup, registry);
        ...
        TransactionalFlow flow = new TransactionalFlow(tailFile);
        Queue<TransactionalFlowFile> output = new LinkedList<>();
        AtomicBoolean successful = new AtomicBoolean(true);
        Thread t = new Thread(() -> successful.set(flow.run(output)));
